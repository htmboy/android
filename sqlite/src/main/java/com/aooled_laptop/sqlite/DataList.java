...
public class DataList extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         * int list_item 表示适配器控件中每项item的布局id
         * Cursor c
         * String[] from 表示cursor中数据表字段的数组
         * int[] to 表示展示字段对应值的控件资源id
         * int flags 设置适配器的标记
         */
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(this, R.layout.list_item, cursor, new String[]{Constant._ID, Constant.NAME, Constant.AGE}, new int[]{R.id.tv_id, R.id.tv_name, R.id.tv_age}, SimpleCursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
